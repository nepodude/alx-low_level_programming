...
/**
 * checkelf - Checking if a file is an ELF file and returnig someting incase
 * it is not..
...
/**
 * printmagic - Printing the magic numbers of an ELF header.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
...
/**
 * printclass - Printing the class of an ELF header.
...
/**
 * printdata - Printing the data of an ELF header.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void printdata(unsigned char *e_ident)
{
...
/**
 * printversion - Printing the version of an ELF header.
...
/**
 * printosabi - Printing the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
void printosabi(unsigned char *e_ident)
{
...
/**
 * printabi - Printing the ABI version of an ELF header.
...
/**
 * printtype - Printing the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void printtype(unsigned int e_type, unsigned char *e_ident)
...
/**
 * printentry - Printing the entry point of an ELF header.
